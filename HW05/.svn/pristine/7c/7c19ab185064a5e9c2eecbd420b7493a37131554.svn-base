...
/**
 * The strategy handles collision
 * @author HaoyuanYue
 * @author YiqingLu
 * @param <TDispMsg> The type of message that the supplied IDispatcher can send. 
 */
public class CollideStrategy<TDispMsg> extends AUpdateStrategy<IBallCmd> {
	 ...
	 * @return The value of the reduced mass
	 */
