...
public class MapLayer extends AnnotationLayer implements Serializable {
	...
	private ToggleAnnotation makeAnnotation(String unselectedText, String selectedText, Position pos) {
		ToggleAnnotation ta = new ToggleAnnotation(unselectedText, selectedText,
				Position.fromDegrees(pos.getLatitude().degrees, pos.getLongitude().degrees, 0));
		return ta;
	}
	 ...
	 */
	public void addToggleAnnotation(String unselectedText, String selectedText, Position pos, double minAltitude,
			double maxAltitude) {
