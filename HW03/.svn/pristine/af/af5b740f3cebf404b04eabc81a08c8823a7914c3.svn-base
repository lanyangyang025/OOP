...
public interface IRandomizer {
	...
	/**
	 * Generates a random location point subject to the constraint that <=X<=rect.width and <=Y<=rect.height.
	...
	/**
	 * Generates a random location point subject to the constraint that <=X<=dim.width and <=Y<=dim.height.
	...
	/**
	 * Returns a random square Dimension, whose width is maxDim.width/<=width<=maxDim.width
